...
<body>
    ...
    <script>
        ...
        function fetchReadings() {
            fetch('../../config/get_alert_responses2.php?')
        ...
        function renderTable(data) {
            const tableBody = document.getElementById('readingsTableGS2').getElementsByTagName('tbody')[0];
