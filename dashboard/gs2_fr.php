...
// Gérer la soumission du formulaire pour l'accusé de réception ou la fausse alarme
...
// Récupérer les relevés de gaz de la base de données avec un statut d'alerte spécifié pour GS2
$query = "
    SELECT 
        sr.readingID, 
        sr.deviceID, 
...
<head>
    ...
    <title>Tableau de Bord ESP32-CapteurGaz 2</title>
    <style>
...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <div class="bottom-section">
                <h3>Langue</h3>
                <li><a href="gs2.php">English</a></li>
            </div>
            <div class="bottom-section">
