...
header('Content-Disposition: attachment; filename="leak_reports.csv"');

$output = fopen('php://output', 'w');
fputcsv($output, array('Device ID', 'Gas Level', 'Gas Detected', 'Alert Status', 'Acknowledged By', 'Response Time', 'Comments', 'Timestamp'));
